                            ...
                            rules: [
                              {
                                ...
                                <div class="mt-4 flex justify-center align-center">
                                    <div>
                                        <div v-if="!isRegister">
                                            Khách hàng mới? <span class="color-orange cursor-pointer"
                                                                  @click="registerUser">
                                                Tạo tài
                                                khoản
                                            </span>
                                        ...
                                        <div v-if="isRegister">
                                            Đã có tài khoản. <span class="color-orange cursor-pointer"
                                                                   @click="loginNow">Đăng nhập ngay</span>
                                        </div>
                                        <div>
                                            Quên mật khẩu? <span class="color-orange cursor-pointer" @click="resetPassword">
                                                Khôi phục mật
                                                khẩu
                                            </span>
                                        </div>
